...
export default function Home() {
  return (
    <main className="max-w-[1240] mx-auto px-5 py-8 nd:py-0">
      <div className="min-h-dvh flex flex-col justify-center gap-16">
        ...
        <div className="flex gap-5 items-stretch flex-col md:flex-row">
          <div className="flex-1 bg-gray-700 norder border-gray-600 rounded-2xl p-8 space-y-6">
          ...
          <form className="bg-gray-700 border-gray-600 rounded-2xl p-8 space-y-6 w-full md:max-w-[440]">
            <h2 className="font-heading font-semibold text-gray-200 text-xl">
              Inscrição
            </h2>
